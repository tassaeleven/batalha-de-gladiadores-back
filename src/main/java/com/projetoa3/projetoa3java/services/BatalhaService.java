...
public class BatalhaService {
    ...
    //         rodada++;
    //         if (rodada > 9) {
    //             return "Vocês lutaram bravamente, mas o combate terminou em empate após 10 rodadas.";
    //         } // mudar lógica, funciona para lança e arco, porém se for espada, a batalha dura 8 rodadas.
